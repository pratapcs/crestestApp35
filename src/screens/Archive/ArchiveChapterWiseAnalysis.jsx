...
const ArchiveChapterWiseAnalysis = props => {
  // console.log("$$$$---props.route.params--", props.route.params.sortName)
  const { examType, subjectId, singleSubjectId, chapterId, sortName, subject, class_id } =
    props.route.params;
  ...
  const scholasticChaptersAnalysisDataPiechart = useSelector(
    state => state.archivePerformance.scholasticChaptersAnalysisDataPiechart,
  );
  const scholasticChaptersAnalysisDataTabledata = useSelector(
    state => state.archivePerformance.scholasticChaptersAnalysisDataTabledata,
  );
  const scholasticChaptersAnalysisCaseStudyDataPiechart = useSelector(
    state => state.archivePerformance.scholasticChaptersAnalysisCaseStudyDataPiechart,
  );
  const scholasticChaptersAnalysisCaseStudyDataTabledata = useSelector(
    state => state.archivePerformance.scholasticChaptersAnalysisCaseStudyDataTabledata,
  );
  ...
  return (
    <KeyboardAvoidingView
      ...
      />
      <HeaderComponent
        headerName={`Archive Chapterwise Analysis ${sortName}`}
...
export default ArchiveChapterWiseAnalysis;
