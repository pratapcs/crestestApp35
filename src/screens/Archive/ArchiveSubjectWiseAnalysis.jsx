...
const ArchiveSubjectWiseAnalysis = props => {
  ...
  const scholasticGetsubjectwiseChaptersPiechart = useSelector(
    state => state.archivePerformance.scholasticGetsubjectwiseChaptersPiechart,
  );
  const scholasticGetsubjectwiseChaptersTabledata = useSelector(
    state => state.archivePerformance.scholasticGetsubjectwiseChaptersTabledata,
  );
  const scholasticSetTableData =
    useSelector(state => state.archivePerformance.scholasticSetTableData) ?? [];
  ...
  const {examType, subjectId, sortName, subject, class_id} = props.route.params;
  ...
  return (
    <KeyboardAvoidingView
      ...
      />
      <HeaderComponent
        headerName={`Archive Subjectwise Analysis ${sortName}`}
              ...
              <SubjectAnalysisCard
                ...
                onPressPaiData={event => {
                  props.navigation.navigate('nonAuthScenes', {
                    screen: 'ArchiveChapterWiseAnalysis',
                    params: {
                      subjectId,
                      examType,
                      sortName,
...
export default ArchiveSubjectWiseAnalysis;
