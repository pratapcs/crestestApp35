...
const ArchiveSubjectWiseCompetitiveScore = props => {
  ...
  const getcompetitiveSetwiseSatScore = useSelector(
    state => state.archivePerformance.getcompetitiveSetwiseSatScore,
  );
  const getcompetitiveSwiseMatScore = useSelector(
    state => state.archivePerformance.getcompetitiveSwiseMatScore,
  );
  const competitiveSetwiseSatScoreSubject = useSelector(
    state => state.archivePerformance.competitiveSetwiseSatScoreSubject,
  );

  const competitiveSetwiseMatScoreSubject = useSelector(
    state => state.archivePerformance.competitiveSetwiseMatScoreSubject,
  );
  ...
  useEffect(() => {
    if (examType !== '' && set_no !== '') {
      if (examType === 'NTSE') {
        dispatch(getAllSubjectWiseCompetitiveScore(set_no, examType, props.route.params.class_id, props));
      } else {
        dispatch(
          getAllSubjectWiseCompetitiveScoreWithoutMat(set_no, examType, props.route.params.class_id, props),
        );
      }
      return () => {
  ...
  return (
    <KeyboardAvoidingView
      ...
      />
      <HeaderComponent
        headerName={`Archive ${examType} Subjectwise Competitive Score`}
              ...
              <CompetitiveGradeGridCard
                ...
                onPressMoreDetails={() => {
                  props.navigation.navigate('nonAuthScenes', {
                    screen: 'ArchiveCompetitiveSubjectwiseAnalysisOnSet',
                    params: {
                      examType: examType,
                      set_no: set_no,
                      subType: 'SAT',
...
export default ArchiveSubjectWiseCompetitiveScore;
