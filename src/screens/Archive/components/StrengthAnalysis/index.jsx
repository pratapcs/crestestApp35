  ...
  return (
    <View style={styles.card}>
      ...
      {/* <LineChart
        ...
        startIndex={0}
        endIndex={20}
        color1="rgba(133, 145, 203, 1)"
        areaChart
        rotateLabel
        labelsExtraHeight={10}
        startFillColor1="rgba(133, 145, 203, 0.5)"
        startFillColor2="rgba(233, 136, 193, 0.5)"
        startFillColor3="rgba(255, 172, 49, 0.5)"
        endFillColor1="rgba(133, 145, 203, 1)"
        endFillColor2="rgba(233, 136, 193, 1)"
        endFillColor3="rgba(255, 172, 49, 1)"
        curved
        startOpacity={0.1}
        endOpacity={0.2}
        data2={setModuleLine}
        ...
        startIndex2={0}
        endIndex2={20}
        color2="rgba(233, 136, 193, 1)"
        color3="rgba(255, 172, 49, 1)"
        width={200}
