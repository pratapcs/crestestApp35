...
const OnlineCompetitiveCategoryPerformance = (props) => {
    ...
    useEffect(() => {
        ...
        // console.log("route==OnlineCompetitiveCategoryPerformance===", props.route.params.isScholasticOrCompetitive)
   ...
   /*  const goToNewPage = (pageName) => {
    ...
    const selectPageHandeler = (item) => {
        ...
        props.navigation.navigate('nonAuthScenes', {
            ...
            params: { examType: item?.type_name, item:item  },
        })
    }
    ...
    return (
        <>
            ...
            >
                ...
                <HeaderComponent
                    headerName='Competitive Performance Score'
...
export default OnlineCompetitiveCategoryPerformance;