...
const ELibraryScholasticPerformanceScore = (props) => {
    ...
    useEffect(() => {
        ...
        dispatch(getelibrarySessionTimeDataDetails(props.route.params.categoryId, 0, props))
        dispatch(elibraryMostVisitedSubjectsDataDetails(props.route.params.categoryId, 0, props))
        dispatch(elibraryMostSearchQuestionsDataDetails(props.route.params.categoryId, 0, props))
    }, []);
    ...
    return (
        <>
            ...
            >
                ...
                <HeaderComponent
                    headerName='e-Library Scholastic Performance Score'
...
export default ELibraryScholasticPerformanceScore;