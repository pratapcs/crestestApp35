...
import { subjectWiseScholasticScoreDataDetails } from '../../store/actions/PerformanceScoreAction';

const SubjectWiseScholasticScore = props => {
  const dispatch = useDispatch();
  const { subjectId, sortName } = props.route.params;
  ...
  useEffect(() => {
    dispatch(subjectWiseScholasticScoreDataDetails(subjectId, props));
  }, []);
  ...
  return (
    <>
      <KeyboardAvoidingView
        ...
        />
        <HeaderComponent
          headerName="Subjectwise Scholastic Score"
...
export default SubjectWiseScholasticScore;
