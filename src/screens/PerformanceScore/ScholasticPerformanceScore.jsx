...
const ScholasticPerformanceScore = props => {
  ...
  const goToNewPage = item => {
    ...
    props.navigation.navigate('nonAuthScenes', {
      screen: 'OverallScholasticPerformanceScore',
      params: { data: item },
    });
  ...
  return (
    <>
      <KeyboardAvoidingView
        ...
        />
        <HeaderComponent
          headerName="Scholastic Performance Score"
        ...
        <ImageBackground
          ...
          <ScrollView
            ...
            {examPurchasedGroupList.map((item, index) => {
              return (
                <TouchableOpacity
                  key={index}
...
export default ScholasticPerformanceScore;
