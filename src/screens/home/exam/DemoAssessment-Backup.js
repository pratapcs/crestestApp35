...
import { colors, scrollViewContainer, fonts, } from '../../../styles/Crestest.config';
                        ...
                        <View style={[Gstyles.pageDetailsTopContainer, Gstyles.jcc, Gstyles.aic]}>
                            ...
                            <View style={[styles.marksContainer, { flexDirection: isPortraitLandscape == 0 ? 'column' : 'row' }]}>
                                <View style={[Gstyles.assessmentDetilsContainer, Gstyles.yellowButtonBackground]}>
                                    <Text style={styles.testDetails}>Correct: {assessmentDetails.filter(i => i.guest_post_ans_status === 1).length} | Incorrect: {assessmentDetails.filter(i => i.guest_post_ans_status === 0 && i.guest_post_ans !== "undefined").length} | Not Attempted: {assessmentDetails.filter(i => i.guest_post_ans_status === 0 && i.guest_post_ans === "undefined").length} | Total: {assessmentDetails.length}</Text>
                                </View>
