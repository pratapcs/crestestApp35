...
import { verificationCodeInputOffAction, sendVerificationOtp, logout } from '../../../store/actions/AuthActions'
...
const DemoVerification = (props) => {
    ...
    const closeVerificationOption = () => {
        console.log("closeVerificationOption--Demo---HIDE_MENU_FROM_BOTTOM")
