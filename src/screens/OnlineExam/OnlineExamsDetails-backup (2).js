                        ...
                        <View style={Gstyles.examTopContainer}>
                            <View style={[Gstyles.examInsideTopContainer, Gstyles.fdr, Gstyles.jcsb]}>
                                ...
                                <View style={Gstyles.examInfoInsideContainer}>
                                    ...
                                    {/* {console.log(".question_counter", currentQuestion[currentQuestionNumber].question_counter )} */}
                                    {/* <View style={Gstyles.examInfoTextContainer}><Text style={Gstyles.examRemainingTextWhite} >{currentQuestion[currentQuestionNumber].question_counter}/{currentQuestion.length}</Text></View> */}
                                </View>

                                <View style={[Gstyles.aic, Gstyles.jcc, { height: 30, flex: .8, }]}>
                                        ...
                                        {!!currentQuestion.length ?
                                            <>
                                                ...
                                                <View style={{ overflow: 'hidden' }}>
                                                    ...
                                                    {/* <ExamCounterClockComponent examTime={299} isPlaying={isPlaying} /> */}
                                                </View>
                                            </>
                                            :
                                            <>
                            ...
                            <View style={Gstyles.showAnswerContainer} >
                                <View style={Gstyles.showAnswerInsideContainer}>
                                    ...
                                    <View style={Gstyles.answerSubmitContainer}>
                                        <TouchableOpacity style={Gstyles.answerSubmitInsideContainer} onPress={submitDemoExamHandeler}>
